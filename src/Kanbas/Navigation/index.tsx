...
import "./index.css";
import { FaTachometerAlt, FaRegUserCircle, FaBook, FaRegCalendarAlt, FaUsers, FaInbox, FaRegClock, FaDesktop, FaQuestionCircle, FaRegQuestionCircle } from "react-icons/fa";
